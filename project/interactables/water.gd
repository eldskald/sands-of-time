# This code was done by Mostly Mad Productions
# https://www.youtube.com/watch?v=hmIRJZEyRMs
# https://www.patreon.com/posts/2d-water-with-4-141384464
...
@export_range(2, 512) var segment_count: int = 16
...
func _initiate_water() -> void:
	...
	new_area.set_collision_mask_value(1, true)
	new_area.set_collision_mask_value(5, true)
	new_area.hide()
